...
<template>
    <div>
        <q-splitter
            ...
            horizontal
            style="height: calc(100vh - 50px - 50px - 30px - 10px)"
                    ...
                    <template v-slot:body="props">
                        <q-tr :props="props">
                            ...
                            <q-td key="metronom" :props="props">
                                ...
                                <!-- <q-popup-edit v-model="editMetronomShow">
                                    <div>
                                        <q-checkbox v-model="props.row.edit.metronom.weekdaySun" label="sunday" />
                                        <q-checkbox v-model="props.row.edit.metronom.weekdayMon" label="monday" />
                                        <q-checkbox v-model="props.row.edit.metronom.weekdayTue" label="tuesday" />
                                ...
                                <!-- <q-dialog v-model="editMetronomShow" square>
                                    <div>edit metronom</div>
                                </q-dialog> -->
                            </q-td>
            ...
            <template v-slot:after>
                <div style="height: 100%; width: 100%; display: flex"></div>
            </template>
        </q-splitter>
    </div>
</template>
